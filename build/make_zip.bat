...
IF EXIST "Notepad2.%NP2_VER%*.exe" COPY /Y /V "Notepad2.%NP2_VER%*.exe" "%TEMP_NAME%\" >NUL
IF EXIST "Notepad2.%NP2_VER%*.zip" COPY /Y /V "Notepad2.%NP2_VER%*.zip" "%TEMP_NAME%\" >NUL

PUSHD "%TEMP_NAME%"

START "" /B /WAIT "..\..\..\distrib\7za.exe" a -tzip -mx=9 Notepad2.zip * >NUL
...
:SubZipFiles
SET "ZIP_NAME=Notepad2.%NP2_VER%_%2%SUFFIX%"
