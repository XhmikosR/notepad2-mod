...
cl /Fo"%OBJDIR%/" /I "%SCISRC%\include" /I "%SCISRC%\src" /I "%SCISRC%\win32" %CLADDCMD% /c /EHsc /MD /O1 /W3 /MP^
 ...
 /Tp "%SCISRC%\src\KeyWords.cxx" /Tp "%SCISRC%\src\LexAsm.cxx" /Tp "%SCISRC%\src\LexConf.cxx"^
 /Tp "%SCISRC%\src\LexCPP.cxx" /Tp "%SCISRC%\src\LexCSS.cxx" /Tp "%SCISRC%\src\LexHTML.cxx"^
 /Tp "%SCISRC%\src\LexOthers.cxx" /Tp "%SCISRC%\src\LexPascal.cxx" /Tp "%SCISRC%\src\LexPerl.cxx"^
 /Tp "%SCISRC%\src\LexPowerShell.cxx" /Tp "%SCISRC%\src\LexPython.cxx" /Tp "%SCISRC%\src\LexSQL.cxx"^
 /Tp "%SCISRC%\src\LexVB.cxx" /Tp "%SCISRC%\src\LineMarker.cxx" /Tp "%SCISRC%\src\PerLine.cxx"^
 /Tp "%SCISRC%\src\PositionCache.cxx" /Tp "%SCISRC%\src\PropSet.cxx" /Tp "%SCISRC%\src\RESearch.cxx"^
 /Tp "%SCISRC%\src\RunStyles.cxx" /Tp "%SCISRC%\src\ScintillaBase.cxx" /Tp "%SCISRC%\src\Selection.cxx"^
 /Tp "%SCISRC%\src\Style.cxx" /Tp "%SCISRC%\src\StyleContext.cxx" /Tp "%SCISRC%\src\UniConversion.cxx"^
 /Tp "%SCISRC%\src\ViewStyle.cxx" /Tp "%SCISRC%\src\WindowAccessor.cxx" /Tp "%SCISRC%\src\XPM.cxx"^
 /Tp "%SCISRC%\win32\PlatWin.cxx" /Tp "%SCISRC%\win32\ScintillaWin.cxx"^
...
link /OUT:"%OUTDIR%/Notepad2.exe" /INCREMENTAL:NO /RELEASE %LNKADDCMD% /OPT:REF /OPT:ICF /MERGE:.rdata=.text^
 ...
 "%OBJDIR%\KeyWords.obj" "%OBJDIR%\LexAsm.obj" "%OBJDIR%\LexConf.obj" "%OBJDIR%\LexCPP.obj"^
 "%OBJDIR%\LexCSS.obj" "%OBJDIR%\LexHTML.obj" "%OBJDIR%\LexOthers.obj" "%OBJDIR%\LexPascal.obj"^
 "%OBJDIR%\LexPerl.obj" "%OBJDIR%\LexPowerShell.obj" "%OBJDIR%\LexPython.obj" "%OBJDIR%\LexSQL.obj"^
 "%OBJDIR%\LexVB.obj" "%OBJDIR%\LineMarker.obj" "%OBJDIR%\Notepad2.obj" "%OBJDIR%\Notepad2.res"^
 "%OBJDIR%\PerLine.obj" "%OBJDIR%\PlatWin.obj" "%OBJDIR%\PositionCache.obj" "%OBJDIR%\Print.obj"^
 "%OBJDIR%\PropSet.obj" "%OBJDIR%\RESearch.obj" "%OBJDIR%\RunStyles.obj" "%OBJDIR%\ScintillaBase.obj"^
 "%OBJDIR%\ScintillaWin.obj" "%OBJDIR%\Selection.obj" "%OBJDIR%\Style.obj" "%OBJDIR%\StyleContext.obj"^
 "%OBJDIR%\Styles.obj" "%OBJDIR%\UniConversion.obj" "%OBJDIR%\ViewStyle.obj"^
