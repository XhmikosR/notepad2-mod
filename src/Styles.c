...
"logtext messagebox miscbuttontext name nop outfile page pop push quit readenvstr readinistr readregdword "
"readregstr reboot regdll rename requestexecutionlevel reservefile return rmdir searchpath sectiongetflags "
