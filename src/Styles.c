...
EDITLEXER lexMARKDOWN = { SCLEX_MARKDOWN, 63336, L"Markdown", L"md; markdown; mdown; mkdn; mkd", L"", &KeyWords_MARKDOWN, {
                          ...
                          { SCE_MARKDOWN_EM1, 63341, L"EM1", L"italic", L"" },
                          { SCE_MARKDOWN_EM2, 63342, L"EM2", L"italic", L"" },
                          { SCE_MARKDOWN_HEADER1, 63343, L"Header 1", L"fore:#FF0088; bold", L"" },
                          { SCE_MARKDOWN_HEADER2, 63344, L"Header 2", L"fore:#FF0088; bold", L"" },
                          { SCE_MARKDOWN_HEADER3, 63345, L"Header 3", L"fore:#FF0088; bold", L"" },
                          { SCE_MARKDOWN_HEADER4, 63346, L"Header 4", L"fore:#FF0088; bold", L"" },
                          { SCE_MARKDOWN_HEADER5, 63347, L"Header 5", L"fore:#FF0088; bold", L"" },
                          { SCE_MARKDOWN_HEADER6, 63348, L"Header 6", L"fore:#FF0088; bold", L"" },
                          { SCE_MARKDOWN_PRECHAR, 63349, L"Pre char", L"fore:#00007F", L"" },
                          { SCE_MARKDOWN_ULIST_ITEM, 63350, L"Ulist", L"fore:#0080FF; bold", L"" },
                          { SCE_MARKDOWN_OLIST_ITEM, 63351, L"Olist", L"fore:#0080FF; bold", L"" },
                          { SCE_MARKDOWN_BLOCKQUOTE, 63352, L"Block quote", L"fore:#00007F", L"" },
                          { SCE_MARKDOWN_STRIKEOUT, 63353, L"Strikeout", L"", L"" },
                          { SCE_MARKDOWN_HRULE, 63354, L"HRULE", L"bold", L"" },
                          { SCE_MARKDOWN_LINK, 63355, L"Link", L"fore:#0000FF", L"" },
                          { MULTI_STYLE(SCE_MARKDOWN_CODE,SCE_MARKDOWN_CODE2,0,0), 63356, L"Code", L"fore:#00007F; back:#EBEBEB", L"" },
                          { SCE_MARKDOWN_CODEBK, 63357, L"Code Block", L"fore:#00007F; back:#EBEBEB", L"" },
                          { -1, 00000, L"", L"", L"" } } };
...
EDITLEXER lexYAML = { SCLEX_YAML, 63358, L"YAML", L"yaml; yml", L"", &KeyWords_YAML, {
                          { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                          ...
                          { SCE_YAML_REFERENCE, 63359, L"Reference", L"fore:#008888", L"" },
                          { SCE_YAML_DOCUMENT, 63360, L"Document", L"fore:#FFFFFF; bold; back:#000088; eolfilled", L"" },
                          { SCE_YAML_TEXT, 63361, L"Text", L"fore:#404040", L"" },
                          { SCE_YAML_ERROR, 63362, L"Error", L"fore:#FFFFFF; bold; italic; back:#FF0000; eolfilled", L"" },
