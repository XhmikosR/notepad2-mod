...
EDITLEXER lexAHK = { SCLEX_AHK, 63306, L"AutoHotKey Script", L"ahk", L"", &KeyWords_AHK, {
                    ...
                    { SCE_AHK_SYNOPERATOR, 63308, L"Syntax Operator", L"fore:#008000; bold", L"" },
                    { SCE_AHK_EXPOPERATOR, 63309, L"Expression operator", L"", L"" },
                    { SCE_AHK_STRING, 63131, L"String", L"fore:#FF8000", L"" },
                    { SCE_AHK_NUMBER, 63130, L"Number", L"fore:#0000FF", L"" },
