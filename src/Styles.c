...
"background base bb bdi bdo bgcolor big blockquote body border bordercolor br buffered button "
...
"datalist datapagesize datasrc datetime dd declare default defer del details dfn dialog dirname "
...
"high hr href hreflang hspace html http-equiv i icon id iframe image img input ins ismap itemprop "
"kbd keygen keytype kind label lang language leftmargin legend li link list longdesc loop low main "
"manifest map marginheight marginwidth mark max maxlength media mediagroup menu menuitem meta meter "
"method min multiple muted name nav noframes nohref noresize noscript noshade novalidate nowrap object "
"ol onabort onafterprint onbeforeprint onbeforeunload onblur oncancel oncanplay oncanplaythrough onchange "
"onclick onclose oncontextmenu oncuechange ondblclick ondrag ondragend ondragenter ondragleave ondragover "
...
"target tbody td text textarea tfoot th thead time title topmargin tr track translate tt type typemustmatch "
"u ul usemap valign value valuetype var version video vlink vspace wbr width wrap xml xmlns",
...
"change-bar-side clear clip clip-path clip-rule color color-profile column-count column-fill column-gap column-rule "
...
"flex-wrap float float-offset flow-from flow-into font font-family font-feature-settings font-size font-synthesis "
...
"hyphenate-limit-last hyphenate-limit-lines hyphenate-limit-zone hyphenate-lines "
"hyphenate-resource hyphens icon image-orientation image-resolution inline-box-align "
"insert-position interpret-as left letter-spacing line-break line-height line-stacking line-stacking-ruby "
...
"marquee-style mathline max-height max-width media min-height min-width move-to nav-down nav-index "
"nav-left nav-right nav-up object-fit object-position opacity order orphans outline outline-color outline-offset "
"outline-style outline-width overflow overflow-style overflow-wrap overflow-x overflow-y padding padding-bottom "
...
"prototype-insert-position punctuation-trim quotes region-overflow rendering-intent resize rest rest-after "
"rest-before richness right rotation rotation-point ruby-align ruby-overhang ruby-position "
"ruby-span shape-image-threshold shape-inside shape-outside size slope speak speak-header speak-numeral "
"speak-punctuation speech-rate src stemh stemv stress string-set table-layout target target-name target-new "
"target-position text-align text-align-last text-decoration text-decoration-color text-decoration-line "
...
"read-only read-write repeat-index repeat-item required right root selection target valid value visited",
"", "", "", "", "", "", "" };
