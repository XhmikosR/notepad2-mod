...
"high hr href hreflang hspace html http-equiv i icon id iframe image img input ins integrity isindex ismap "
"itemprop kbd keygen keytype kind label lang language leftmargin legend li link list longdesc loop low main "
...
"reset rev reversed role rows rowspan rp rt ruby rules s samp sandbox scheme scope scoped script "
